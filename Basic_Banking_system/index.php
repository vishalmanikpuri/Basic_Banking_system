...
<body>
  ...
  ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row py-1" style="background: #747ba1;">
    ...
    <footer class="text-center my-5 py-2 font-size" style="background:#1D8DFC;">
        <p class="myText">&copy 2021. Made by <b>Vishal Manikpuri</b> <br> The Sparks Foundation</p>
    </footer>
